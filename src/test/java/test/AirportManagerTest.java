...
public class AirportManagerTest {
	...
	@Test
	public void totalAirports() {
		AirportManager manager = new AirportManager(service);
		int expected = 65510;
		assertEquals(expected, manager.totalAirports());
	}

	@Test
	public void testGetRandomAirport() {
		AirportManager manager = new AirportManager(service);
		String expected = "Total Rf Heliport";
		Mockito.when(service.getRandomAirport()).thenReturn("Total Rf Heliport");
	...
	public void listAirportsSorted() {
		...
		assertNotNull(manager.listAirportsSorted());
	}
